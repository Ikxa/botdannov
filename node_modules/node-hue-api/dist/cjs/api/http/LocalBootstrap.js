    ...
    connect(username, clientkey, timeout) {
        ...
        return httpClient.request({
            ...
            return (0, sslCertificate_1.getSSLCertificate)(hostname)
                ...
                .then(agent => {
                const apiBaseUrl = `${baseUrl}api`, transport = new Transport_1.Transport(httpClient.create({ baseURL: apiBaseUrl, httpsAgent: agent }), this.rateLimits.transportRateLimit, username), config = {
                    remote: false,
                    baseUrl: apiBaseUrl,
